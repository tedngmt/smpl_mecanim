...
public class SMPLBlendshapes : MonoBehaviour {
	...
	/*	Bridge for external pose sources (e.g. MotionStreamClient) to drive this avatar's
	 *	bones directly, since _modifyBones is only created once Start() has run.
	 */
	public bool ApplyStreamedPose(float[][] pose, float[] trans)
	{
